...
export default defineConfig({
  ...
  schema: { collections: [
    ...
    },
    {
      ...
      path:'content/flash',
      format:'mdx',
      ui: { router: ({ document }) => `/flash/${document._sys.filename}` },
      fields:[
    ...
    },
    {
      name:'onSkinWorks',
      label:'Тату на коже',
      path:'content/on-skin',
      format:'mdx',
      ui: { router: ({ document }) => `/on-skin/${document._sys.filename}` },
      fields:[
        {type:'string',name:'title',label:'Название',isTitle:true,required:true},
        {type:'string',name:'category',label:'Категория'},
        {type:'image',name:'image',label:'Картинка'},
    ...
    },
    {
      ...
      format:'mdx',
      ui: { router: ({ document }) => `/portfolio/${document._sys.filename}` },
      fields:[
        {type:'string',name:'title',label:'Название',isTitle:true,required:true},
