  ...
  return (
    <main className="site-shell">
      ...
      <section className="section about-section" id="about">
        <div className="section-label">01 / {copy.about}</div>
      ...
      <section className="section portfolio-section" id="portfolio">
        <div className="section-head"><div><div className="section-label">02 / {copy.portfolio}</div><h2>Little pieces<br /><em>of magic.</em></h2></div><p>Every piece is drawn with a lot of care.<br />More work on Instagram ↗</p></div>
