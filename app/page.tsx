...
export default function Page() {
  ...
  return <main className="site-shell"><SiteHeader />
    ...
    <section className="section max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 contact-section"><Deco className="deco-contact">♡</Deco><Constellation area="contact-extra" /><div className="section-label">♡ 05 / {c.contact}</div><h2>{c.contactText}</h2><div className="contact-actions"><a className="primary-button" href={instagram} target="_blank" rel="noreferrer">{c.book} <ArrowUpRight size={16} /></a><a className="instagram-link" href={instagram} target="_blank" rel="noreferrer"><Instagram size={18} /> Instagram · @kisu.tatts</a></div></section>
  </main>
}
