...
const Card = ({ item }: { item: any }) => <div className={`portfolio-card ${item[2]}`}>{item[3] ? <img className="portfolio-image" src={item[3]} alt={item[0]} /> : <span className="art-shape" />}<span className="art-label"><b>{item[0]}</b><small>{item[1]}</small></span></div>
