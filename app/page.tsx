...
export default function Page() {
  ...
  return <main className="site-shell"><SiteHeader />
    ...
    <section className="section portfolio-section"><div className="section-label">✦ 02 / {c.portfolio}</div><div className="section-head"><h2>Little pieces<br /><span>of magic.</span></h2><p>Every piece is drawn with care.<br />More work on Instagram ↗</p></div><div className="portfolio-grid">{featuredPortfolio.slice(0, 3).map((item: any) => <Card key={item[0]} item={item} />)}</div><Link className="text-link" href="/portfolio">View all portfolio <ArrowUpRight size={15} /></Link></section>
